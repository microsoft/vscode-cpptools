...
// The following is used to generate nativeStrings.ts and localized_string_ids.h from ./src/LanguageServer/nativeStrings.json
...
`;
    ...
    for (let property in stringTable) {
        ...
        for (;;) {
            ...
            typeScriptContents += `, stringArgs[${argIndex}]`;
            ++argIndex;
        }
        typeScriptContents += ");\n            break;\n";
        ++stringIndex;
    };
    // Terminate typescript file
    typeScriptContents += "        default:\n            console.assert(\"Unrecognized string ID\");\n            break;\n    }\n    return message;\n}\n";
