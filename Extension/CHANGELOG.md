...
* Fix `#include` completion not working with `compile_commands.json` and custom configuration providers. [#2242](https://github.com/Microsoft/vscode-cpptools/issues/2242)
