...
* Fix the IntelliSense process launching when it's disabled when the Copilot extension is used. [#12750](https://github.com/microsoft/vscode-cpptools/issues/12750), [#13058](https://github.com/microsoft/vscode-cpptools/issues/13058)
* Fix the IntelliSense mode being `macos` instead of `windows` when `_WIN32` is defined. [#13016](https://github.com/Microsoft/vscode-cpptools/issues/13016)
...
* Fix the `C_Cpp.default.compilerPath` being generated without using the `C_Cpp.preferredPathSeparator` setting. [#13083](https://github.com/microsoft/vscode-cpptools/issues/13083)
