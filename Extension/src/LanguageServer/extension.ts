...
import { sendCallHierarchyCallsFromRequest, sendCallHierarchyCallsToRequest, sendPrepareCallHierarchyRequest } from './callHierarchy';
import { sendGoToDefinitionRequest } from './goToDefinition';
...
export async function registerCommands(enabled: boolean): Promise<void> {
    ...
    commandDisposables.push(vscode.commands.registerCommand('C_Cpp.FoldInactiveRegions', enabled ? onFoldInactiveRegions : onDisabledCommand));
