...
export function registerCommands(enabled: boolean): void {
    ...
    commandDisposables.push(vscode.commands.registerCommand('C_Cpp.GenerateDoxygenComment', (cursorLine, cursorColumn, line, column) =>  getActiveClient().handleGenerateDoxygenComment(cursorLine, cursorColumn, line, column)));
}
