...
export class CppSettings extends Settings {
    ...
    public get autoCompleteAddParenthesesAfterFunctionCalls(): boolean | undefined { return super.Section.get<boolean>("autocomplete.addParenthesesAfterFunctionCalls"); }
