...
interface TextDocumentWillSaveParams {
...
export interface Client {
    ...
    onWillSaveWaitUntil(params: TextDocumentWillSaveParams): Promise<void>;
...
export class DefaultClient implements Client {
    ...
    public async onWillSaveWaitUntil(params: TextDocumentWillSaveParams): Promise<void> {
        await this.awaitUntilLanguageClientReady();
        await this.languageClient.sendRequest(WillSaveWaitUntilRequest, params);
    }
...
class NullClient implements Client {
    ...
    notifyWhenLanguageClientReady(notify: () => void): void { }
    awaitUntilLanguageClientReady(): void { }
    onWillSaveWaitUntil(params: TextDocumentWillSaveParams): Promise<void> {  return Promise.resolve(); }
