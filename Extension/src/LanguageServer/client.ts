...
// const DocumentFormatRequest: RequestType<EditorConfigParams, , void, void> = new RequestType<GetFoldingRangesParams, GetFoldingRangesResult, void, void>('cpptools/documentFormat');
