...
const QueryTranslationUnitSourceRequest: RequestType<
  QueryTranslationUnitSourceParams,
  QueryTranslationUnitSourceResult,
  void,
  void
> = new RequestType<
  QueryTranslationUnitSourceParams,
  ...
  void,
  void
>("cpptools/queryTranslationUnitSource");
const SwitchHeaderSourceRequest: RequestType<
  SwitchHeaderSourceParams,
  string,
  void,
  void
> = new RequestType<SwitchHeaderSourceParams, string, void, void>(
  "cpptools/didSwitchHeaderSource"
);
const GetDiagnosticsRequest: RequestType<
  void,
  GetDiagnosticsResult,
  void,
  void
> = new RequestType<void, GetDiagnosticsResult, void, void>(
  "cpptools/getDiagnostics"
);
const GetCodeActionsRequest: RequestType<
...
export const GetFoldingRangesRequest: RequestType<
  ...
  void,
  void
> = new RequestType<GetFoldingRangesParams, GetFoldingRangesResult, void, void>(
  "cpptools/getFoldingRanges"
);
export const GetSemanticTokensRequest: RequestType<
...
> = new RequestType<
  ...
  void,
  void
>("cpptools/getSemanticTokens");
export const DocumentFormatRequest: RequestType<
  FormatParams,
  TextEdit[],
  void,
  void
> = new RequestType<FormatParams, TextEdit[], void, void>("cpptools/format");
// Notifications to the server
const DidOpenNotification: NotificationType<
  DidOpenTextDocumentParams,
  void
> = new NotificationType<DidOpenTextDocumentParams, void>(
  "textDocument/didOpen"
);
const FileCreatedNotification: NotificationType<
  FileChangedParams,
  void
> = new NotificationType<FileChangedParams, void>("cpptools/fileCreated");
const FileChangedNotification: NotificationType<
  FileChangedParams,
  void
> = new NotificationType<FileChangedParams, void>("cpptools/fileChanged");
const FileDeletedNotification: NotificationType<
  FileChangedParams,
  void
> = new NotificationType<FileChangedParams, void>("cpptools/fileDeleted");
const ResetDatabaseNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/resetDatabase");
const PauseParsingNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/pauseParsing");
const ResumeParsingNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/resumeParsing");
const ActiveDocumentChangeNotification: NotificationType<
  TextDocumentIdentifier,
  void
> = new NotificationType<TextDocumentIdentifier, void>(
  "cpptools/activeDocumentChange"
);
const TextEditorSelectionChangeNotification: NotificationType<
  Range,
  void
> = new NotificationType<Range, void>("cpptools/textEditorSelectionChange");
const ChangeCppPropertiesNotification: NotificationType<
  CppPropertiesParams,
  void
> = new NotificationType<CppPropertiesParams, void>(
  "cpptools/didChangeCppProperties"
);
const ChangeCompileCommandsNotification: NotificationType<
  FileChangedParams,
  void
> = new NotificationType<FileChangedParams, void>(
  "cpptools/didChangeCompileCommands"
);
const ChangeSelectedSettingNotification: NotificationType<
  FolderSelectedSettingParams,
  void
> = new NotificationType<FolderSelectedSettingParams, void>(
  "cpptools/didChangeSelectedSetting"
);
const IntervalTimerNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/onIntervalTimer");
const CustomConfigurationNotification: NotificationType<
  CustomConfigurationParams,
  void
> = new NotificationType<CustomConfigurationParams, void>(
  "cpptools/didChangeCustomConfiguration"
);
const CustomBrowseConfigurationNotification: NotificationType<
  CustomBrowseConfigurationParams,
  void
> = new NotificationType<CustomBrowseConfigurationParams, void>(
  "cpptools/didChangeCustomBrowseConfiguration"
);
const ClearCustomConfigurationsNotification: NotificationType<
  WorkspaceFolderParams,
  void
> = new NotificationType<WorkspaceFolderParams, void>(
  "cpptools/clearCustomConfigurations"
);
const ClearCustomBrowseConfigurationNotification: NotificationType<
  WorkspaceFolderParams,
  void
> = new NotificationType<WorkspaceFolderParams, void>(
  "cpptools/clearCustomBrowseConfiguration"
);
const RescanFolderNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/rescanFolder");
export const RequestReferencesNotification: NotificationType<
  boolean,
  void
> = new NotificationType<boolean, void>("cpptools/requestReferences");
export const CancelReferencesNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/cancelReferences");
const FinishedRequestCustomConfig: NotificationType<
  string,
  void
> = new NotificationType<string, void>("cpptools/finishedRequestCustomConfig");
const FindAllReferencesNotification: NotificationType<
  FindAllReferencesParams,
  void
> = new NotificationType<FindAllReferencesParams, void>(
  "cpptools/findAllReferences"
);
const RenameNotification: NotificationType<
  RenameParams,
  void
> = new NotificationType<RenameParams, void>("cpptools/rename");
const DidChangeSettingsNotification: NotificationType<
  DidChangeConfigurationParams,
  void
> = new NotificationType<DidChangeConfigurationParams, void>(
  "cpptools/didChangeSettings"
);
const AbortRequestNotification: NotificationType<
  AbortRequestParams,
  void
> = new NotificationType<AbortRequestParams, void>("cpptools/abortRequest");

// Notifications from the server
const ReloadWindowNotification: NotificationType<
  void,
  void
> = new NotificationType<void, void>("cpptools/reloadWindow");
const LogTelemetryNotification: NotificationType<
  TelemetryPayload,
  void
> = new NotificationType<TelemetryPayload, void>("cpptools/logTelemetry");
const ReportTagParseStatusNotification: NotificationType<
  LocalizeStringParams,
  void
> = new NotificationType<LocalizeStringParams, void>(
  "cpptools/reportTagParseStatus"
);
const ReportStatusNotification: NotificationType<
  ReportStatusNotificationBody,
  void
> = new NotificationType<ReportStatusNotificationBody, void>(
  "cpptools/reportStatus"
);
const DebugProtocolNotification: NotificationType<
  DebugProtocolParams,
  void
> = new NotificationType<DebugProtocolParams, void>("cpptools/debugProtocol");
const DebugLogNotification: NotificationType<
  LocalizeStringParams,
  void
> = new NotificationType<LocalizeStringParams, void>("cpptools/debugLog");
const InactiveRegionNotification: NotificationType<
  InactiveRegionParams,
  void
> = new NotificationType<InactiveRegionParams, void>(
  "cpptools/inactiveRegions"
);
const CompileCommandsPathsNotification: NotificationType<
  CompileCommandsPaths,
  void
> = new NotificationType<CompileCommandsPaths, void>(
  "cpptools/compileCommandsPaths"
);
const ReferencesNotification: NotificationType<
  refs.ReferencesResultMessage,
  void
> = new NotificationType<refs.ReferencesResultMessage, void>(
  "cpptools/references"
);
const ReportReferencesProgressNotification: NotificationType<
  refs.ReportReferencesProgressNotification,
  void
> = new NotificationType<refs.ReportReferencesProgressNotification, void>(
  "cpptools/reportReferencesProgress"
);
const RequestCustomConfig: NotificationType<
  string,
  void
> = new NotificationType<string, void>("cpptools/requestCustomConfig");
const PublishDiagnosticsNotification: NotificationType<
  PublishDiagnosticsParams,
  void
> = new NotificationType<PublishDiagnosticsParams, void>(
  "cpptools/publishDiagnostics"
);
const ShowMessageWindowNotification: NotificationType<
  ShowMessageWindowParams,
  void
> = new NotificationType<ShowMessageWindowParams, void>(
  "cpptools/showMessageWindow"
);
const ReportTextDocumentLanguage: NotificationType<
  string,
  void
> = new NotificationType<string, void>("cpptools/reportTextDocumentLanguage");
const SemanticTokensChanged: NotificationType<
  string,
  void
> = new NotificationType<string, void>("cpptools/semanticTokensChanged");
...
export class DefaultClient implements Client {
  ...
  public get TagParsingChanged(): vscode.Event<boolean> {
    return this.model.isTagParsing.ValueChanged;
  }
  public get IntelliSenseParsingChanged(): vscode.Event<boolean> {
    return this.model.isUpdatingIntelliSense.ValueChanged;
  }
  public get ReferencesCommandModeChanged(): vscode.Event<
  ...
  public get TagParserStatusChanged(): vscode.Event<string> {
    return this.model.tagParserStatus.ValueChanged;
  }
          ...
          () => {
              ...
              public async provideCodeActions(
                ...
                return this.client.requestWhenReady(() => {
                  ...
                  return this.client.languageClient
                    .sendRequest(GetCodeActionsRequest, params)
                    .then((commands) => {
                      const resultCodeActions: vscode.CodeAction[] = [];

                      // Convert to vscode.CodeAction array
                      commands.forEach((command) => {
                        const title: string = util.getLocalizedString(
            ...
            if (firstClient) {
              ...
              return languageClient
                .sendRequest(QueryCompilerDefaultsRequest, {})
                .then((inputCompilerDefaults: configs.CompilerDefaults) => {
                  ...
                  if (settings.formattingEngine !== "Disabled") {
                    this.documentFormattingProviderDisposable = vscode.languages.registerDocumentFormattingEditProvider(
                      this.documentSelector,
                      new DocumentFormattingEditProvider(this)
                    );
                    this.formattingRangeProviderDisposable = vscode.languages.registerDocumentRangeFormattingEditProvider(
                      this.documentSelector,
                      new DocumentRangeFormattingEditProvider(this)
                    );
                    this.onTypeFormattingProviderDisposable = vscode.languages.registerOnTypeFormattingEditProvider(
                      this.documentSelector,
                  ...
                  if (settings.codeFolding) {
                    this.codeFoldingProviderDisposable = vscode.languages.registerFoldingRangeProvider(
                      this.documentSelector,
                      new FoldingRangeProvider(this)
                    );
                  }
                  if (
                    settings.enhancedColorization &&
                    this.semanticTokensLegend
                  ) {
                    this.semanticTokensProvider = new SemanticTokensProvider(
                      this
                    );
                    this.semanticTokensProviderDisposable = vscode.languages.registerDocumentSemanticTokensProvider(
                      this.documentSelector,
  ...
  private createLanguageClient(allClients: ClientCollection): LanguageClient {
...

    {
      ...
      for (const setting of settings) {
        settings_clangFormatPath.push(
          util.resolveVariables(
            setting.clangFormatPath,
        ...
        settings_indentWithinParentheses.push(
          setting.vcFormatIndentWithinParentheses
        );
        settings_indentPreserveWithinParentheses.push(
          setting.vcFormatindentPreserveWithinParentheses
        );
        settings_indentMultiLine.push(
          setting.vcFormatIndentMultiLineRelativeTo
        );
        ...
        settings_indentCaseContentsWhenBlock.push(
          setting.vcFormatIndentCaseContentsWhenBlock
        );
        settings_indentLambdaBracesWhenParameter.push(
          setting.vcFormatIndentLambdaBracesWhenParameter
        );
        ...
        settings_indentAccessSpecifiers.push(
          setting.vcFormatIndentAccessSpecifiers
        );
        settings_indentNamespaceContents.push(
          setting.vcFormatIndentNamespaceContents
        );
        settings_indentPreserveComment.push(
          setting.vcFormatIndentPreserveComment
        );
        settings_newLineBeforeOpenBraceNamespace.push(
          setting.vcFormatNewlineBeforeOpenBraceNamespace
        );
        settings_newLineBeforeOpenBraceType.push(
          setting.vcFormatNewlineBeforeOpenBraceType
        );
        settings_newLineBeforeOpenBraceFunction.push(
          setting.vcFormatNewlineBeforeOpenBraceFunction
        );
        settings_newLineBeforeOpenBraceBlock.push(
          setting.vcFormatNewlineBeforeOpenBraceBlock
        );
        settings_newLineScopeBracesOnSeparateLines.push(
          setting.vcFormatNewlineScopeBracesOnSeparateLines
        );
        settings_newLineBeforeOpenBraceLambda.push(
          setting.vcFormatNewlineBeforeOpenBraceLambda
        );
        settings_newLineCloseBraceSameLineEmptyType.push(
          setting.vcFormatNewlineCloseBraceSameLineEmptyType
        );
        settings_newLineCloseBraceSameLineEmptyFunction.push(
          setting.vcFormatNewlineCloseBraceSameLineEmptyFunction
        );
        ...
        settings_newLineBeforeWhileInDoWhile.push(
          setting.vcFormatNewlineBeforeWhileInDoWhile
        );
        settings_spaceBeforeFunctionOpenParenthesis.push(
          setting.vcFormatSpaceBeforeFunctionOpenParenthesis
        );
        settings_spaceWithinParameterListParentheses.push(
          setting.vcFormatSpaceWithinParameterListParentheses
        );
        settings_spaceBetweenEmptyParameterListParentheses.push(
          setting.vcFormatSpaceBetweenEmptyParameterListParentheses
        );
        settings_spaceAfterKeywordsInControlFlowStatements.push(
          setting.vcFormatSpaceAfterKeywordsInControlFlowStatements
        );
        settings_spaceWithinControlFlowStatementParentheses.push(
          setting.vcFormatSpaceWithinControlFlowStatementParentheses
        );
        settings_spaceBeforeLambdaOpenParenthesis.push(
          setting.vcFormatSpaceBeforeLambdaOpenParenthesis
        );
        settings_spaceWithinCastParentheses.push(
          setting.vcFormatSpaceWithinCastParentheses
        );
        settings_spaceSpaceAfterCastCloseParenthesis.push(
          setting.vcFormatSpaceAfterCastCloseParenthesis
        );
        settings_spaceWithinExpressionParentheses.push(
          setting.vcFormatSpaceWithinExpressionParentheses
        );
        settings_spaceBeforeBlockOpenBrace.push(
          setting.vcFormatSpaceBeforeBlockOpenBrace
        );
        settings_spaceBetweenEmptyBraces.push(
          setting.vcFormatSpaceBetweenEmptyBraces
        );
        settings_spaceBeforeInitializerListOpenBrace.push(
          setting.vcFormatSpaceBeforeInitializerListOpenBrace
        );
        settings_spaceWithinInitializerListBraces.push(
          setting.vcFormatSpaceWithinInitializerListBraces
        );
        settings_spacePreserveInInitializerList.push(
          setting.vcFormatSpacePreserveInInitializerList
        );
        settings_spaceBeforeOpenSquareBracket.push(
          setting.vcFormatSpaceBeforeOpenSquareBracket
        );
        settings_spaceWithinSquareBracketse.push(
          setting.vcFormatSpaceWithinSquareBrackets
        );
        settings_spaceBeforeEmptySquareBrackets.push(
          setting.vcFormatSpaceBeforeEmptySquareBrackets
        );
        settings_spaceBetweenEmptySquareBrackets.push(
          setting.vcFormatSpaceBetweenEmptySquareBrackets
        );
        settings_spaceGroupSquareBrackets.push(
          setting.vcFormatSpaceGroupSquareBrackets
        );
        settings_spaceWithinLambdaBrackets.push(
          setting.vcFormatSpaceWithinLambdaBrackets
        );
        settings_spaceBetweenEmptyLambdaBrackets.push(
          setting.vcFormatSpaceBetweenEmptyLambdaBrackets
        );
        ...
        settings_spaceRemoveAroundMemberOperators.push(
          setting.vcFormatSpaceRemoveAroundMemberOperators
        );
        settings_spaceBeforeInheritanceColon.push(
          setting.vcFormatSpaceBeforeInheritanceColon
        );
        settings_spaceBeforeConstructorColon.push(
          setting.vcFormatSpaceBeforeConstructorColon
        );
        settings_spaceRemoveBeforeSemicolon.push(
          setting.vcFormatSpaceRemoveBeforeSemicolon
        );
        settings_spaceInsertAfterSemicolon.push(
          setting.vcFormatSpaceInsertAfterSemicolon
        );
        settings_spaceRemoveAroundUnaryOperator.push(
          setting.vcFormatSpaceRemoveAroundUnaryOperator
        );
        settings_spaceAroundBinaryOperator.push(
          setting.vcFormatSpaceAroundBinaryOperator
        );
        settings_spaceAroundAssignmentOperator.push(
          setting.vcFormatSpaceAroundAssignmentOperator
        );
        settings_spacePointerReferenceAlignment.push(
          setting.vcFormatSpacePointerReferenceAlignment
        );
        settings_spaceAroundTernaryOperator.push(
          setting.vcFormatSpaceAroundTernaryOperator
        );
        ...
        settings_clangFormatFallbackStyle.push(
          setting.clangFormatFallbackStyle
        );
        ...
        settings_intelliSenseEngineFallback.push(
          setting.intelliSenseEngineFallback
        );
        settings_errorSquiggles.push(setting.errorSquiggles);
        settings_dimInactiveRegions.push(setting.dimInactiveRegions);
        settings_enhancedColorization.push(
          setting.enhancedColorization ? "Enabled" : "Disabled"
        );
        ...
        settings_defaultSystemIncludePath.push(
          setting.defaultSystemIncludePath
        );
        settings_intelliSenseCachePath.push(
          util.resolveCachePath(
            setting.intelliSenseCachePath,
            this.AdditionalEnvironment
          )
        );
        ...
        closed: () => {
          ...
          if (languageClientCrashTimes.length < 5) {
            allClients.forEach((client) => {
              allClients.replace(client, true);
            });
          } else {
            const elapsed: number =
              languageClientCrashTimes[languageClientCrashTimes.length - 1] -
            ...
            if (elapsed <= 3 * 60 * 1000) {
              ...
              allClients.forEach((client) => {
                allClients.replace(client, false);
              });
            } else {
  ...
  public sendAllSettings(): void {
    ...
    {
      const cppSettingsResourceScoped: vscode.WorkspaceConfiguration = vscode.workspace.getConfiguration(
        "C_Cpp",
        this.RootUri
      );
      const cppSettingsNonScoped: vscode.WorkspaceConfiguration = vscode.workspace.getConfiguration(
        "C_Cpp"
      );

      for (const key in cppSettingsResourceScoped) {
        const curSetting: any =
          util.packageJson.contributes.configuration.properties["C_Cpp." + key];
        if (curSetting === undefined) {
          continue;
        }
        const settings: vscode.WorkspaceConfiguration =
          curSetting.scope === "resource" ||
          curSetting.scope === "machine-overridable"
            ? cppSettingsResourceScoped
            : cppSettingsNonScoped;
        cppSettingsScoped[key] = settings.get(key);
      }
      cppSettingsScoped["default"] = {
        systemIncludePath: cppSettingsResourceScoped.get(
    ...
    const settings: any = {
      C_Cpp: {
        ...
        vcFormat: {
          ...
          indent: vscode.workspace.getConfiguration(
            "C_Cpp.vcFormat.indent",
            this.RootUri
          ),
          newLine: {
            ...vscode.workspace.getConfiguration(
              "C_Cpp.vcFormat.newLine",
              this.RootUri
            ),
            beforeOpenBrace: vscode.workspace.getConfiguration(
              "C_Cpp.vcFormat.newLine.beforeOpenBrace",
              this.RootUri
            ),
            closeBraceSameLine: vscode.workspace.getConfiguration(
              "C_Cpp.vcFormat.newLine.closeBraceSameLine",
              this.RootUri
            ),
          },
          space: vscode.workspace.getConfiguration(
            "C_Cpp.vcFormat.space",
            this.RootUri
          ),
          wrap: vscode.workspace.getConfiguration(
            "C_Cpp.vcFormat.wrap",
            this.RootUri
          ),
        },
        tabSize: vscode.workspace.getConfiguration(
          "editor.tabSize",
          this.RootUri
        ),
      },
      files: {
        exclude: vscode.workspace.getConfiguration(
          "files.exclude",
          this.RootUri
        ),
  ...
  public sendDidChangeSettings(settings: any): void {
    ...
    this.notifyWhenReady(() => {
      this.languageClient.sendNotification(DidChangeSettingsNotification, {
        settings,
    ...
    if (settings.dimInactiveRegions) {
      ...
      for (const e of editors) {
        const valuePair:
          ...
          | undefined = this.inactiveRegionsDecorations.get(
  ...
  public onDidChangeTextDocument(
    ...
    if (textDocumentChangeEvent.document.uri.scheme === "file") {
      if (
        ...
        textDocumentChangeEvent.document.languageId === "c"
      ) {
  ...
  public onRegisterCustomConfigurationProvider(
    provider: CustomConfigurationProvider1
  ): Thenable<void> {
    ...
    return this.notifyWhenReady(() => {
      ...
      const selectedProvider: string | undefined = this.configuration
        .CurrentConfigurationProvider;
      if (!selectedProvider) {
        const ask: PersistentFolderState<boolean> = new PersistentFolderState<
          boolean
        >("Client.registerProvider", true, rootFolder);
        // If c_cpp_properties.json and settings.json are both missing, reset our prompt
        if (
          !fs.existsSync(`${this.RootPath}/.vscode/c_cpp_properties.json`) &&
          !fs.existsSync(`${this.RootPath}/.vscode/settings.json`)
        ) {
          ask.Value = true;
        }
        if (ask.Value) {
          ui.showConfigureCustomProviderMessage(
            () => {
              ...
              const dontAllow: string = localize(
                "dont.allow.button",
                "Don't Allow"
              );
              const askLater: string = localize(
                "ask.me.later.button",
                "Ask Me Later"
              );

              return vscode.window
                .showInformationMessage(message, allow, dontAllow, askLater)
                .then((result) => {
                  switch (result) {
                    case allow: {
                      this.configuration
                        .updateCustomConfigurationProvider(provider.extensionId)
                        .then(() => {
                          onRegistered();
                          ask.Value = false;
                          telemetry.logLanguageServerEvent(
        ...
        isSameProviderExtensionId(selectedProvider, provider.extensionId)
      ) {
        onRegistered();
  ...
  public updateCustomConfigurations(
    requestingProvider?: CustomConfigurationProvider1
  ): Thenable<void> {
    return this.notifyWhenReady(() => {
      ...
      const currentProvider:
        | CustomConfigurationProvider1
        | undefined = getCustomConfigProviders().get(
  ...
  public updateCustomBrowseConfiguration(
    requestingProvider?: CustomConfigurationProvider1
  ): Thenable<void> {
    return this.notifyWhenReady(() => {
      if (!this.configurationProvider) {
      ...
      const task: () => Thenable<WorkspaceBrowseConfiguration | null> = async () => {
        if (
          ...
          return currentProvider.provideFolderBrowseConfiguration(
            this.RootUri,
            tokenSource.token
          );
        }
        if (
          await currentProvider.canProvideBrowseConfiguration(tokenSource.token)
        ) {
        ...
        async (config) => {
          ...
          if (currentProvider.version < Version.v3) {
            ...
            for (const c of config.browsePath) {
              if (
                vscode.workspace.getWorkspaceFolder(vscode.Uri.file(c)) ===
                this.RootFolder
              ) {
      ...
      global.setTimeout(async () => {
        if (!hasCompleted) {
          ...
          if (currentProvider.version >= Version.v2) {
            console.warn(
              "Configuration Provider timed out in {0}ms.",
  ...
  public async logDiagnostics(): Promise<void> {
    const response: GetDiagnosticsResult = await this.requestWhenReady(() =>
      this.languageClient.sendRequest(GetDiagnosticsRequest, null)
    );
    ...
    if (tuSearchStart >= 0) {
      ...
      if (tuSearchEnd >= 0 && tuSearchEnd > tuSearchStart) {
        let tuSearchString: string = response.diagnostics.substr(
          tuSearchStart,
          tuSearchEnd - tuSearchStart
        );
        let tuSearchIndex: number = tuSearchString.indexOf("[");
        while (tuSearchIndex >= 0) {
          const tuMatch: RegExpMatchArray | null = tuSearchString.match(
            /\[\s(.*)\s\]/
          );
  ...
  public async rescanFolder(): Promise<void> {
    await this.notifyWhenReady(() =>
      this.languageClient.sendNotification(RescanFolderNotification)
    );
  }

  public async provideCustomConfiguration(
    docUri: vscode.Uri,
    requestFile?: string
  ): Promise<void> {
    ...
    const provider:
      | CustomConfigurationProvider1
      | undefined = getCustomConfigProviders().get(providerId);
    if (!provider) {
      onFinished();
      return Promise.resolve();
    }
    ...
    return this.queueBlockingTask(async () => {
      ...
      const provideConfigurationAsync: () => Thenable<
        SourceFileConfigurationItem[] | null | undefined
      > = async () => {
        if (provider) {
          for (let i: number = 0; i < response.candidates.length; ++i) {
            try {
              ...
              if (
                await provider.canProvideConfiguration(tuUri, tokenSource.token)
              ) {
                const configs: SourceFileConfigurationItem[] = await provider.provideConfigurations(
                  [tuUri],
                  tokenSource.token
                );
      ...
      return this.callTaskWithTimeout(
        ...
        (err) => {
          ...
          const settings: CppSettings = new CppSettings(this.RootUri);
          if (
            settings.configurationWarnings === "Enabled" &&
            ...
            const configName: string | undefined = this.configuration
              .CurrentConfiguration?.name;
            if (!configName) {
              return;
            }
            let message: string = localize(
              "unable.to.provide.configuraiton",
            ...
            vscode.window
              .showInformationMessage(message, dismiss, disable)
              .then((response) => {
                switch (response) {
                  case disable: {
  ...
  private async handleRequestCustomConfig(requestFile: string): Promise<void> {
    await this.provideCustomConfiguration(
      vscode.Uri.file(requestFile),
      requestFile
    );
  }
  ...
  private isExternalHeader(uri: vscode.Uri): boolean {
    ...
    return (
      !rootUri ||
      (util.isHeader(uri) && !uri.toString().startsWith(rootUri.toString()))
    );
  }

  public getCurrentConfigName(): Thenable<string | undefined> {
    return this.queueTask(() =>
      Promise.resolve(this.configuration.CurrentConfiguration?.name)
    );
  }

  public getCurrentConfigCustomVariable(
    variableName: string
  ): Thenable<string> {
    return this.queueTask(() =>
      Promise.resolve(
        this.configuration.CurrentConfiguration?.customConfigurationVariables?.[
          variableName
        ] || ""
      )
    );
  ...
  public getCurrentCompilerPathAndArgs(): Thenable<
    util.CompilerPathAndArgs | undefined
  > {
    return this.queueTask(() =>
      Promise.resolve(
  ...
  public getVcpkgInstalled(): Thenable<boolean> {
    return this.queueTask(() =>
      Promise.resolve(this.configuration.VcpkgInstalled)
    );
  }
  ...
  public getKnownCompilers(): Thenable<configs.KnownCompiler[] | undefined> {
    return this.queueTask(() =>
      Promise.resolve(this.configuration.KnownCompiler)
    );
  }
  ...
  public takeOwnership(document: vscode.TextDocument): void {
    ...
    this.notifyWhenReady(() =>
      this.languageClient.sendNotification(DidOpenNotification, params)
    );
  ...
  private registerNotifications(): void {
    ...
    this.languageClient.onNotification(ReloadWindowNotification, () =>
      util.promptForReloadWindowDueToSettingsChange()
    );
    this.languageClient.onNotification(LogTelemetryNotification, logTelemetry);
    this.languageClient.onNotification(ReportStatusNotification, (e) =>
      this.updateStatus(e)
    );
    this.languageClient.onNotification(ReportTagParseStatusNotification, (e) =>
      this.updateTagParseStatus(e)
    );
    this.languageClient.onNotification(InactiveRegionNotification, (e) =>
      this.updateInactiveRegions(e)
    );
    this.languageClient.onNotification(CompileCommandsPathsNotification, (e) =>
      this.promptCompileCommands(e)
    );
    this.languageClient.onNotification(ReferencesNotification, (e) =>
      this.processReferencesResult(e.referencesResult)
    );
    ...
    this.languageClient.onNotification(
      RequestCustomConfig,
      (requestFile: string) => {
        const client: DefaultClient = <DefaultClient>(
          clientCollection.getClientFor(vscode.Uri.file(requestFile))
        );
    ...
    this.languageClient.onNotification(SemanticTokensChanged, (e) =>
      this.semanticTokensProvider?.invalidateFile(e)
    );
    setupOutputHandlers();
  }
  ...
  private registerFileWatcher(): void {
    ...
    if (this.rootFolder) {
      ...
      this.rootPathFileWatcher.onDidCreate((uri) => {
        ...
        this.languageClient.sendNotification(FileCreatedNotification, {
          uri: uri.toString(),
        });
      });
      ...
      this.rootPathFileWatcher.onDidChange((uri) => {
        ...
        if (dotIndex !== -1) {
          ...
          if (this.associations_for_did_change?.has(ext)) {
            ...
            if (duration < 10000) {
              this.languageClient.sendNotification(FileChangedNotification, {
                uri: uri.toString(),
              });
            }
          }
      ...
      this.rootPathFileWatcher.onDidDelete((uri) => {
        ...
        this.languageClient.sendNotification(FileDeletedNotification, {
          uri: uri.toString(),
        });
      });
  ...
  private updateStatus(notificationBody: ReportStatusNotificationBody): void {
    ...
    if (message.endsWith("Indexing...")) {
      ...
      if (notificationBody.workspaceFolderUri) {
        const client: DefaultClient = <DefaultClient>(
          clientCollection.getClientFor(
            vscode.Uri.file(notificationBody.workspaceFolderUri)
          )
        );
        if (!client.configuration.CurrentConfiguration?.configurationProvider) {
          const showIntelliSenseFallbackMessage: PersistentState<boolean> = new PersistentState<
            boolean
          >("CPP.showIntelliSenseFallbackMessage", true);
          if (showIntelliSenseFallbackMessage.Value) {
            ui.showConfigureIncludePathMessage(
              () => {
                const configJSON: string = localize(
                  "configure.json.button",
                  "Configure (JSON)"
                );
                const configUI: string = localize(
                  "configure.ui.button",
                  "Configure (UI)"
                );
  ...
  private updateTagParseStatus(notificationBody: LocalizeStringParams): void {
    this.model.tagParserStatus.Value = util.getLocalizedString(
      notificationBody
    );
  }
  ...
  private updateInactiveRegions(params: InactiveRegionParams): void {
    ...
    if (opacity !== null && opacity !== undefined) {
      let backgroundColor: string | undefined =
        settings.inactiveRegionBackgroundColor;
      if (backgroundColor === "") {
      ...
      const valuePair:
        | DecorationRangesPair
        | undefined = this.inactiveRegionsDecorations.get(params.uri);
      if (valuePair) {
        ...
        // The entry does not exist. Make a new one
      ...
      if (
        ...
        params.fileVersion === openFileVersions.get(params.uri)
      ) {
  ...
  private promptCompileCommands(params: CompileCommandsPaths): void {
    ...
    const client: DefaultClient = <DefaultClient>(
      clientCollection.getClientFor(vscode.Uri.file(params.workspaceFolderUri))
    );
    if (
      client.configuration.CurrentConfiguration?.compileCommands ||
      client.configuration.CurrentConfiguration?.configurationProvider
    ) {
      return;
    }
    ...
    const ask: PersistentFolderState<boolean> = new PersistentFolderState<
      boolean
    >("CPP.showCompileCommandsSelection", true, rootFolder);
    if (!ask.Value) {
      return;
    }

    const aCompileCommandsFile: string = localize(
      "a.compile.commands.file",
      "a compile_commands.json file"
    );
    const compileCommandStr: string =
      params.paths.length > 1 ? aCompileCommandsFile : params.paths[0];
    const message: string =
      vscode.workspace.workspaceFolders &&
      vscode.workspace.workspaceFolders.length > 1
        ? localize(
    ...
    ui.showConfigureCompileCommandsMessage(
      () => {
        ...
        return vscode.window
          .showInformationMessage(message, yes, no, askLater)
          .then(async (value) => {
            switch (value) {
              case yes:
                if (params.paths.length > 1) {
                  const index: number = await ui.showCompileCommands(
                    params.paths
                  );
                  if (index < 0) {
                    return false;
   ...
   */
  public requestSwitchHeaderSource(
    rootPath: string,
    fileName: string
  ): Thenable<string> {
  ...
  public selectionChanged(selection: Range): void {
    this.notifyWhenReady(() => {
      this.languageClient.sendNotification(
        TextEditorSelectionChangeNotification,
        selection
      );
    });
  }
  ...
  public resetDatabase(): void {
    this.notifyWhenReady(() =>
      this.languageClient.sendNotification(ResetDatabaseNotification)
    );
  }
  ...
  public pauseParsing(): void {
    this.notifyWhenReady(() =>
      this.languageClient.sendNotification(PauseParsingNotification)
    );
  }

  public resumeParsing(): void {
    this.notifyWhenReady(() =>
      this.languageClient.sendNotification(ResumeParsingNotification)
    );
  }
  ...
  private onConfigurationsChanged(
    ...
    if (!rootFolder) {
      this.languageClient.sendNotification(
        ChangeCppPropertiesNotification,
        params
      );
    } else {
      const lastCustomBrowseConfigurationProviderId: PersistentFolderState<
        string | undefined
      ...
      const lastCustomBrowseConfiguration: PersistentFolderState<
        WorkspaceBrowseConfiguration | undefined
      > = new PersistentFolderState<WorkspaceBrowseConfiguration | undefined>(
        "CPP.lastCustomBrowseConfiguration",
        undefined,
        rootFolder
      );
      if (!this.doneInitialCustomBrowseConfigurationCheck) {
        ...
        if (
          isSameProviderExtensionId(
            lastCustomBrowseConfigurationProviderId.Value,
            configurations[params.currentConfiguration].configurationProvider
          )
        ) {
      ...
      if (sendLastCustomBrowseConfiguration) {
        this.sendCustomBrowseConfiguration(
          lastCustomBrowseConfiguration.Value,
          lastCustomBrowseConfigurationProviderId.Value
        );
      }
    }
    ...
    const newProvider: string | undefined = this.configuration
      .CurrentConfigurationProvider;
  ...
  private sendCustomConfigurations(configs: any): void {
    ...
    if (settings.loggingLevel === "Debug") {
      out.appendLine(
        localize("configurations.received", "Custom configurations received:")
      );
    }
    ...
    configs.forEach((item) => {
      if (this.isSourceFileConfigurationItem(item)) {
        ...
        if (
          item.configuration.includePath.some((path) => path.endsWith("**"))
        ) {
          console.warn(
        ...
        // Separate compiler path and args before sending to language client
        const itemConfig: util.Mutable<SourceFileConfiguration> = {
          ...item.configuration,
        };
    ...
    this.languageClient.sendNotification(
      CustomConfigurationNotification,
      params
    );
  }
  ...
  private sendCustomBrowseConfiguration(
    ...
    while (true) {
      ...
      if (
        !util.isArrayOfString(sanitized.browsePath) ||
    ...
    this.languageClient.sendNotification(
      CustomBrowseConfigurationNotification,
      params
    );
  }
  ...
  public handleConfigurationSelectCommand(): void {
    this.notifyWhenReady(() => {
      const configNames: string[] | undefined = this.configuration
        .ConfigurationNames;
      if (configNames) {
        ui.showConfigurations(configNames).then((index: number) => {
          if (index < 0) {
            return;
          }
  ...
  public handleConfigurationProviderSelectCommand(): void {
    this.notifyWhenReady(() => {
      ui.showConfigurationProviders(
        ...
        this.configuration
          .updateCustomConfigurationProvider(extensionId)
          .then(() => {
            if (extensionId) {
              const provider:
                | CustomConfigurationProvider1
                | undefined = getCustomConfigProviders().get(extensionId);
  ...
  public handleShowParsingCommands(): void {
    this.notifyWhenReady(() => {
      ui.showParsingCommands().then((index: number) => {
        if (index === 0) {
          this.pauseParsing();
        } else if (index === 1) {
          this.resumeParsing();
  ...
  public handleConfigurationEditCommand(): void {
    this.notifyWhenReady(() =>
      this.configuration.handleConfigurationEditCommand(
        undefined,
  ...
  public handleConfigurationEditJSONCommand(): void {
    this.notifyWhenReady(() =>
      this.configuration.handleConfigurationEditJSONCommand(
        undefined,
        vscode.window.showTextDocument
      )
    );
  ...
  public handleConfigurationEditUICommand(): void {
    this.notifyWhenReady(() =>
      this.configuration.handleConfigurationEditUICommand(
        undefined,
        vscode.window.showTextDocument
      )
    );
  ...
  public dispose(): Thenable<void> {
    const promise: Thenable<void> =
      this.languageClient && clientCollection.Count === 0
  ...
  public cancelReferences(): void {
    ...
    if (
      DefaultClient.referencesRequestPending ||
      workspaceReferences.symbolSearchInProgress
    ) {
      const cancelling: boolean = DefaultClient.referencesPendingCancellations.length > 0;
  ...
  private processReferencesResult(
