...
class ClientModel {
    ...
    constructor() {
        ...
        this.isParsingWorkspace = new DataBinding<boolean>(false, 300, false); // 300ms must elapse before the icon can hide itself.
        this.isParsingWorkspacePaused = new DataBinding<boolean>(false);
        this.isParsingFiles = new DataBinding<boolean>(false, 300, false); // 300ms must elapse before the icon can hide itself.
        this.isUpdatingIntelliSense = new DataBinding<boolean>(false, 300, false); // 300ms must elapse before the icon can hide itself.
