...
If you have any questions, check out our [FAQs](https://code.visualstudio.com/docs/cpp/faq-cpp). If you do not find your answer there, feel free to ask it in our [issues page](https://github.com/Microsoft/vscode-cpptools/issues).
